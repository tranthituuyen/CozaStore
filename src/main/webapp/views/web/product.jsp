            ...
            <div class="container">
                ...
                <div class="flex-w flex-sb-m p-b-52">
                    <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                        ...
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women">Thời trang nữ</button>
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".men">Thời trang nam</button>
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".bag">Balo</button>
                        ...
                        <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                            <div class="filter-col1 p-r-15 p-b-27">
                                ...
                                <ul>
                                    ...
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">Đánh giá trung bình</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04 filter-link-active">Mới nhất</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">Giá: Thấp đến cao</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">Giá: Cao đến thấp</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="filter-col2 p-r-15 p-b-27">
                                ...
                                <ul>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04 filter-link-active">Tất cả</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">0đ - 200.000đ</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">200.000đ - 400.000đ</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">400.000đ - 600.000đ</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">600.000đ - 800.000đ</a></li>
                                    <li class="p-b-6"><a href="#" class="filter-link stext-106 trans-04">> 800.000đ</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="filter-col4 p-b-27">
                                ...
                                <div class="flex-w p-t-4 m-r--5">
                                    <a class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 trans-04 m-r-5 m-b-5" href="#">Fashion</a>
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Esprit Ruffle Shirt
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Herschel supply
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Only Check Trouser
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Classic Trench Coat
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Front Pocket Jumper
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Vintage Inspired Classic
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Shirt in Stretch Cotton</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Pieces Metallic Printed
                                    </a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="<c:url value='/views/web/product-detail.jsp' />"
                                       class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Converse All Star Hi Plimsolls
                                    </a>
                                    <span class="stext-105 cl3">$75.00</span>
                                </div>
