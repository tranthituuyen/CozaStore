    ...
    <div class="container">
        <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
            <button class="how-pos3 hov3 trans-04 js-hide-modal1">
                <img src="<c:url value='/templates/web/icons/icon-close.png' />" alt="CLOSE">
            </button>
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="<c:url value='/images/products/smkt-vang.jpg' />">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="<c:url value='/images/products/smkt-vang.jpg' />"
                                             alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick3" data-thumb="<c:url value='/images/products/smkt-vang-2.jpg' />">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="<c:url value='/images/products/smkt-vang-2.jpg' />"
                                             alt="IMG-PRODUCT">
                                ...
                                <div class="item-slick3" data-thumb="<c:url value='/images/products/smkt-vang-3.jpg' />">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="<c:url value='/images/products/smkt-vang-3.jpg' />"
                                             alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                           href="<c:url value='/images/products/smkt-vang-3.jpg' />">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                    </div>
                                </div>
