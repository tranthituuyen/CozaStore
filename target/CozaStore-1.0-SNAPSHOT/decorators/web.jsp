...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css"
              href="<c:url value='/templates/web/iconic/css/material-design-iconic-font.min.css' />" media="all"/>
        <link rel="stylesheet" type="text/css"
              href="<c:url value='/templates/common/fonts/linearicons-v1.0.0/icon-font.min.css' />" media="all"/>
        <link rel="stylesheet" type="text/css" href="<c:url value='/templates/web/animation/animate.css' />"
              media="all"/>
        <link rel="stylesheet" type="text/css" href="<c:url value='/templates/web/css/hamburgers.min.css' />"
              media="all"/>
        <link rel="stylesheet" type="text/css" href="<c:url value='/templates/web/animation/css/animsition.min.css' />"
              media="all"/>
        <link rel="stylesheet" type="text/css" href="<c:url value='/templates/web/select2/select2.min.css' />"
              media="all"/>
        <link rel="stylesheet" type="text/css"
              href="<c:url value='/templates/web/daterangepicker/daterangepicker.css' />" media="all"/>
        <link rel="stylesheet" type="text/css" href="<c:url value='/templates/web/slick/slick.css' />" media="all"/>
        <link rel="stylesheet" type="text/css" href="<c:url value='/templates/web/MagnificPopup/magnific-popup.css' />"
              media="all"/>
        <link rel="stylesheet" type="text/css"
              href="<c:url value='/templates/web/perfect-scrollbar/perfect-scrollbar.css' />" media="all"/>
        <link rel="stylesheet" type="text/css"
              href="<c:url value='/templates/common/bootstrap/css/bootstrap.min.css' />" media="all"/>
        ...
        <script src="<c:url value="/templates/common/pagination/jquery.twbsPagination.js" />"
    ...
    <body class="animsition">
        ...
        <script src="<c:url value='/templates/web/daterangepicker/daterangepicker.js' />"
                type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            $('.js-addwish-b2').each(function () {
                var nameProduct = $(this).parent().parent().find('.js-name-b2').html().toUpperCase();
            ...
            $('.js-addcart-detail').each(function () {
                var nameProduct = $(this).parent().parent().parent().parent().find('.js-name-detail').html().toUpperCase();
                $(this).on('click', function () {
